...
CREATE TABLE employee (
    e_nik VARCHAR(20) PRIMARY KEY NOT NULL,
...
CREATE TABLE computer (
    ...
    pc_serviceprice DECIMAL(9, 2) NOT NULL,
...
insert into employee (e_nik, e_name, e_phone, e_address, e_position) values
('98765432', 'Alex Johnson', '555-1111', '456 Oak Street, Citytown, Districtburg, 56789', 'PC Mechanic'),
('82321321', 'Beth Davis', '555-2222', '789 Pine Road, Townsville, Stateburg, 67890', 'Cashier'),
('23456789', 'Chris Smith', '555-3333', '101 Elm Lane, Villagetown, Countyland, 34567', 'PC Mechanic'),
('65432198', 'Diana Miller', '555-4444', '202 Maple Road, Suburbia, Provinceland, 45678', 'PC Mechanic'),
('43219876', 'Ethan Turner', '555-5555', '303 Cedar Street, Countryside, Territorytown, 98765', 'Cashier'),
('78901234', 'Fiona White', '555-6666', '404 Birch Avenue, Hamletville, Regionville, 87654', 'PC Mechanic'),
('87654321', 'George Baker', '555-7777', '505 Oak Lane, Cityville, Districtburg, 76543', 'Manager'),
('34567890', 'Hannah Taylor', '555-8888', '606 Pine Road, Townsville, Stateburg, 65432', 'Cashier'),
('62322198', 'Ian Brown', '555-9999', '707 Elm Street, Villagetown, Countyland, 54321', 'PC Mechanic'),
('23423389', 'Julia Clark', '555-0000', '808 Maple Avenue, Suburbia, Provinceland, 43210', 'Manager'),
('98765435', 'Lily Martinez', '555-1112', '124 Pine Lane, Citytown, Districtburg, 56789', 'PC Mechanic'),
('82321111', 'Michael Adams', '555-2223', '457 Oak Street, Townsville, Stateburg, 67890', 'Cashier'),
('23456787', 'Olivia Wilson', '555-3334', '790 Maple Road, Villagetown, Countyland, 34567', 'PC Mechanic'),
('65432199', 'Peter Garcia', '555-4445', '102 Cedar Street, Suburbia, Provinceland, 45678', 'PC Mechanic'),
('43219877', 'Samantha Turner', '555-5556', '203 Birch Avenue, Countryside, Territorytown, 98765', 'Cashier'),
('78901236', 'Tom Wright', '555-6667', '304 Elm Lane, Hamletville, Regionville, 87654', 'PC Mechanic'),
('87654323', 'Violet Davis', '555-7778', '405 Pine Road, Cityville, Districtburg, 76543', 'Cashier'),
('34567892', 'William Baker', '555-8889', '506 Maple Road, Townsville, Stateburg, 65432', 'PC Mechanic'),
('62322332', 'Sophie Taylor', '555-9990', '607 Cedar Street, Villagetown, Countyland, 54321', 'PC Mechanic'),
('23423567', 'Eli Clark', '555-0001', '808 Maple Avenue, Suburbia, Provinceland, 43210', 'Cashier'),
('86543210', 'Aria Turner', '555-1113', '125 Pine Lane, Citytown, Districtburg, 56789', 'PC Mechanic'),
('87651235', 'Nathan Harris', '555-2224', '458 Oak Street, Townsville, Stateburg, 67890', 'Cashier'),
('43210988', 'Mila Evans', '555-3335', '791 Maple Road, Villagetown, Countyland, 34567', 'PC Mechanic'),
('98762346', 'Owen Baker', '555-4446', '103 Cedar Street, Suburbia, Provinceland, 45678', 'PC Mechanic'),
('78903457', 'Penelope White', '555-5557', '204 Birch Avenue, Countryside, Territorytown, 98765', 'Cashier'),
('56789023', 'Quincy Johnson', '555-6668', '305 Elm Lane, Hamletville, Regionville, 87654', 'PC Mechanic'),
('43216544', 'Ruby Turner', '555-7779', '406 Pine Road, Cityville, Districtburg, 76543', 'Cashier'),
('98760124', 'Simon Clark', '555-8890', '507 Maple Road, Townsville, Stateburg, 65432', 'PC Mechanic'),
('87651236', 'Tara Davis', '555-9991', '608 Cedar Street, Villagetown, Countyland, 54321', 'PC Mechanic'),
('12349088', 'Upton Smith', '555-0002', '808 Birch Avenue, Suburbia, Provinceland, 43210', 'Cashier'),
('23456790', 'Valerie Harris', '555-1114', '126 Pine Lane, Citytown, Districtburg, 56789', 'PC Mechanic'),
('34567891', 'Winston Baker', '555-2225', '459 Oak Street, Townsville, Stateburg, 67890', 'Cashier'),
('45678902', 'Xander Evans', '555-3336', '792 Maple Road, Villagetown, Countyland, 34567', 'PC Mechanic'),
('56789013', 'Yara Baker', '555-4447', '104 Cedar Street, Suburbia, Provinceland, 45678', 'PC Mechanic'),
('67890124', 'Zane Turner', '555-5558', '205 Birch Avenue, Countryside, Territorytown, 98765', 'Cashier'),
('78901235', 'Amelia Turner', '555-6669', '306 Elm Lane, Hamletville, Regionville, 87654', 'PC Mechanic'),
('89012346', 'Benjamin Clark', '555-7780', '407 Pine Road, Cityville, Districtburg, 76543', 'Cashier'),
('90123457', 'Cassandra Harris', '555-8891', '508 Maple Road, Townsville, Stateburg, 65432', 'PC Mechanic'),
('12345679', 'Dylan Baker', '555-9992', '609 Cedar Street, Villagetown, Countyland, 54321', 'PC Mechanic');
...
('T0001', 'Purchase', 'Card', NULL, '2023-01-16', NULL, 'C0001', '82321321', NULL),
('T0002', 'Service', 'Cash', NULL, '2023-01-19', '2023-01-21', 'C0002', '98765432', 'PC0001'),
('T0003', 'Build', 'Card', 'Build me a pc that is not too expensive but is okay for work', '2023-01-20', '2023-01-25', 'C0003', '23456789', NULL),
('T0004', 'Purchase', 'Cash', NULL, '2023-01-20', NULL, 'C0004', '43219876', NULL),
('T0005', 'Service', 'Cash', NULL, '2023-01-21', '2023-01-22', 'C0005', '65432198', 'PC0002'),
('T0006', 'Purchase', 'Card', NULL, '2023-01-21', NULL, 'C0006', '43219876', NULL),
('T0007', 'Purchase', 'Cash', NULL, '2023-01-22', NULL, 'C0007', '82321321', NULL),
('T0008', 'Purchase', 'Cash', NULL, '2023-01-24', NULL, 'C0008', '34567890', NULL),
('T0009', 'Purchase', 'Card', NULL, '2023-01-24', NULL, 'C0009', '82321321', NULL),
('T0010', 'Purchase', 'Card', NULL, '2023-01-27', NULL, 'C0010', '43219876', NULL),
('T0011', 'Purchase', 'Cash', NULL, '2023-01-28', NULL, 'C0011', '34567890', NULL),
('T0012', 'Purchase', 'Card', NULL, '2023-01-28', NULL, 'C0012', '43219876', NULL),
('T0013', 'Purchase', 'Card', NULL, '2023-01-29', NULL, 'C0013', '34567890', NULL),
('T0014', 'Service', 'Cash', NULL, '2023-01-29', '2023-01-30', 'C0014', '78901234', 'PC0003'),
('T0015', 'Service', 'Cash', NULL, '2023-01-30', '2023-01-31', 'C0015', '98765432', 'PC0004'),
('T0016', 'Purchase', 'Cash', NULL, '2023-02-01', NULL, 'C0016', '34567890', NULL),
('T0017', 'Purchase', 'Card', NULL, '2023-02-03', NULL, 'C0017', '82321321', NULL),
('T0018', 'Purchase', 'Card', NULL, '2023-02-03', NULL, 'C0018', '43219876', NULL),
('T0019', 'Purchase', 'Cash', NULL, '2023-02-03', NULL, 'C0019', '34567890', NULL),
('T0020', 'Purchase', 'Card', NULL, '2023-02-04', NULL, 'C0020', '43219876', NULL),
('T0021', 'Purchase', 'Card', NULL, '2023-02-06', NULL, 'C0021', '34567890', NULL),
('T0022', 'Build', 'Card', 'Build me an awesome gaming pc', '2023-02-06', '2023-02-13', 'C0022', '78901234', NULL),
('T0023', 'Purchase', 'Cash', NULL, '2023-02-07', NULL, 'C0023', '34567890', NULL),
('T0024', 'Purchase', 'Card', NULL, '2023-02-07', NULL, 'C0024', '82321321', NULL),
('T0025', 'Purchase', 'Card', NULL, '2023-02-08', NULL, 'C0025', '43219876', NULL),
('T0026', 'Purchase', 'Cash', NULL, '2023-02-10', NULL, 'C0026', '34567890', NULL),
('T0027', 'Purchase', 'Card', NULL, '2023-02-11', NULL, 'C0027', '43219876', NULL),
('T0028', 'Purchase', 'Card', NULL, '2023-02-11', NULL, 'C0028', '82321321', NULL),
('T0029', 'Purchase', 'Card', NULL, '2023-02-13', NULL, 'C0029', '43219876', NULL),
('T0030', 'Purchase', 'Cash', NULL, '2023-02-16', NULL, 'C0030', '34567890', NULL),
('T0031', 'Purchase', 'Card', NULL, '2023-02-16', NULL, 'C0031', '82321321', NULL),
('T0032', 'Purchase', 'Card', NULL, '2023-02-17', NULL, 'C0032', '34567890', NULL),
('T0033', 'Service', 'Cash', NULL, '2023-02-19', '2023-02-20', 'C0034', '78901234', 'PC0005'),
('T0034', 'Build', 'Card', 'Build me a cheap office pc', '2023-02-20', '2023-02-27', 'C0034', '62322198', NULL),
('T0035', 'Service', 'Cash', NULL, '2023-02-20', '2023-02-21', 'C0035', '23456789', 'PC0006'),
('T0036', 'Purchase', 'Card', NULL, '2023-02-21', NULL, 'C0036', '43219876', NULL),
('T0037', 'Purchase', 'Cash', NULL, '2023-02-22', NULL, 'C0037', '82321321', NULL),
('T0038', 'Purchase', 'Cash', NULL, '2023-02-24', NULL, 'C0038', '82321321', NULL),
('T0039', 'Purchase', 'Card', NULL, '2023-02-24', NULL, 'C0039', '34567890', NULL),
('T0040', 'Purchase', 'Card', NULL, '2023-02-27', NULL, 'C0040', '43219876', NULL),
('T0041', 'Purchase', 'Card', NULL, '2023-02-28', NULL, 'C0001', '43219876', NULL),
('T0042', 'Purchase', 'Cash', NULL, '2023-03-01', NULL, 'C0002', '89012346', NULL),
('T0043', 'Purchase', 'Card', NULL, '2023-03-02', NULL, 'C0003', '23456789', NULL),
('T0044', 'Purchase', 'Card', NULL, '2023-03-03', NULL, 'C0004', '82321111', NULL),
('T0045', 'Purchase', 'Cash', NULL, '2023-03-03', NULL, 'C0005', '65432198', NULL),
('T0046', 'Purchase', 'Card', NULL, '2023-03-04', NULL, 'C0006', '82321111', NULL),
('T0047', 'Purchase', 'Cash', NULL, '2023-03-06', NULL, 'C0007', '12349088', NULL),
('T0048', 'Purchase', 'Card', NULL, '2023-03-07', NULL, 'C0008', '34567890', NULL),
('T0049', 'Purchase', 'Card', NULL, '2023-03-07', NULL, 'C0009', '12349088', NULL),
('T0050', 'Purchase', 'Cash', NULL, '2023-03-09', NULL, 'C0010', '43219876', NULL),
('T0051', 'Purchase', 'Card', NULL, '2023-03-10', NULL, 'C0011', '34567890', NULL),
('T0052', 'Purchase', 'Card', NULL, '2023-03-10', NULL, 'C0012', '43219876', NULL),
('T0053', 'Purchase', 'Cash', NULL, '2023-03-11', NULL, 'C0013', '87651235', NULL),
('T0054', 'Purchase', 'Card', NULL, '2023-03-13', NULL, 'C0014', '89012346', NULL),
('T0055', 'Purchase', 'Cash', NULL, '2023-03-13', NULL, 'C0015', '12349088', NULL),
('T0056', 'Purchase', 'Card', NULL, '2023-03-14', NULL, 'C0016', '87651235', NULL),
('T0057', 'Purchase', 'Card', NULL, '2023-03-16', NULL, 'C0017', '82321321', NULL),
('T0058', 'Purchase', 'Cash', NULL, '2023-03-17', NULL, 'C0018', '89012346', NULL),
('T0059', 'Purchase', 'Card', NULL, '2023-03-17', NULL, 'C0019', '34567890', NULL),
('T0060', 'Purchase', 'Card', NULL, '2023-03-18', NULL, 'C0020', '43219876', NULL),
('T0061', 'Purchase', 'Cash', NULL, '2023-03-20', NULL, 'C0021', '34567890', NULL),
('T0062', 'Purchase', 'Card', NULL, '2023-03-20', NULL, 'C0022', '78901234', NULL),
('T0063', 'Purchase', 'Card', NULL, '2023-03-21', NULL, 'C0023', '34567890', NULL),
('T0064', 'Purchase', 'Cash', NULL, '2023-03-22', NULL, 'C0024', '82321321', NULL),
('T0065', 'Purchase', 'Card', NULL, '2023-03-24', NULL, 'C0025', '82321111', NULL),
('T0066', 'Purchase', 'Card', NULL, '2023-03-25', NULL, 'C0026', '87651235', NULL),
('T0067', 'Purchase', 'Cash', NULL, '2023-03-27', NULL, 'C0027', '12349088', NULL),
('T0068', 'Purchase', 'Card', NULL, '2023-03-28', NULL, 'C0028', '82321321', NULL),
('T0069', 'Purchase', 'Card', NULL, '2023-03-29', NULL, 'C0029', '89012346', NULL),
('T0070', 'Purchase', 'Cash', NULL, '2023-03-31', NULL, 'C0030', '87651235', NULL),
('T0071', 'Purchase', 'Card', NULL, '2023-03-31', NULL, 'C0031', '82321321', NULL),
('T0072', 'Purchase', 'Card', NULL, '2023-04-01', NULL, 'C0032', '34567890', NULL),
('T0073', 'Purchase', 'Cash', NULL, '2023-04-03', NULL, 'C0033', '82321321', NULL),
('T0074', 'Purchase', 'Card', NULL, '2023-04-03', NULL, 'C0034', '98765432', NULL),
('T0075', 'Purchase', 'Card', NULL, '2023-04-04', NULL, 'C0035', '87651235', NULL),
('T0076', 'Purchase', 'Cash', NULL, '2023-04-05', NULL, 'C0036', '43219876', NULL),
('T0077', 'Purchase', 'Card', NULL, '2023-04-05', NULL, 'C0037', '82321321', NULL),
('T0078', 'Purchase', 'Card', NULL, '2023-04-06', NULL, 'C0038', '34567890', NULL),
('T0079', 'Purchase', 'Cash', NULL, '2023-04-07', NULL, 'C0039', '82321321', NULL),
('T0080', 'Purchase', 'Card', NULL, '2023-04-07', NULL, 'C0040', '12349088', NULL);
...
-- 1
-- Name and Nik of PC Mechanics who've worked on PCs that gets slow
...
where pc_issue like '%slow%' or pc_issue like '%Slow%'
order by pc_id
...
-- 3
-- List the cashiers who hasn't assisted in any transaction
...
-- 4
-- List Customer's name, their customer id, and the amount of items they've bought from the store and sort it by the most items bought to the least
