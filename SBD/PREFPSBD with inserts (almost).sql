...
SELECT * from supplier
    WHERE s_id in (
		select supplier_s_id from (
			SELECT product.supplier_s_id, COUNT(product.supplier_s_id) AS numof_products from product
				GROUP BY product.supplier_s_id
				ORDER BY numof_products DESC
				LIMIT 5
	)
)
