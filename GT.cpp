...
int main()
{
    ...
    for(int i = 0; i < n; i++){
        ...
        // for(int j = 0; j < int(EmployeeID.size()); j++)
        //     cout << EmployeeID[j] << endl;
        // getChromaticNumber(EmployeeID);
        // for(int j = 0; j < int(storage.size()); j++){
        //     cout << "ID: " << EmployeeID[j] << " " << "Color: " << storage[j] << endl;
        // }
        
        if (EmployeeID.size() < 5){
            for(int j = 0; j < 5; j++){
                cout << days[j] << endl;
                for(int k = 0; k < EmployeeID.size(); k++){
                    cout << posName << " " << EmployeeID[k] << endl;
                }
                cout << endl;
            }
        }
            ...
            while (!EmployeeID.empty()){
                for(int j = 0; j < 5 && !EmployeeID.empty(); j++){
                    splitIds.push_back(EmployeeID.front());
                    EmployeeID.pop_front();
                }
                getChromaticNumber(splitIds);
                splitIds.clear();
            }
            for(int j = 0; j < 5; j++){
                cout << days[j] << endl;
                for (int k = 0; k < storage[j].size(); k++){
                    cout << posName << " " << storage[j][k] << endl;
                }
                cout << endl;
            }
            // float perShift = EmployeeID.size() / 5.0;
            // perShift = ceil(perShift);
            // cout << perShift << endl;
            // for(int j = 0; j < 5; j++){
            //     cout << days[j] << endl;
            //     for(int k = 0; k < perShift; k++){
            //         if (!EmployeeID.empty()){
            //             cout << posName << " " << EmployeeID.front() << endl;
            //             EmployeeID.pop_front();
            //         }
            //     }
            //     cout << endl;
        ...
        // if (EmployeeID.size() % 5 == 0){
        //     int perShift = int(EmployeeID.size() / 5);
        //     for(int j = 0; j < 5; j++){
        //         cout << days[j] << endl;
        //         for(int k = 0; k < perShift; k++){
        //             cout << "Employee ID: " << EmployeeID.front() << endl;
        //             EmployeeID.pop_front();
        //         }
        //         cout << endl;
        //     }
        // }
        // else if (EmployeeID.size() < 10){
        //     for(int j = 0; j < 5; j++){
        //         cout << days[j] << endl;
        //         for(int k = 0; k < int(EmployeeID.size()); k++){
        //                 cout << "Employee ID: "<< EmployeeID[k] << endl;
        //         }
        //         // if (j < int(EmployeeID.size())){
        //         //     cout << "Employee ID: " << EmployeeID[j] << endl;
        //         // }
        //         // else {
        //         //     for(int k = 0; k < int(EmployeeID.size()); k++){
        //         //         cout << "Employee ID: "<< EmployeeID[k] << endl;
