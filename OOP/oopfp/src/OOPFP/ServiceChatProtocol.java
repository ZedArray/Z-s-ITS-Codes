...
public class ServiceChatProtocol {
    ...
    public String processInput(String input){
        ...
        if(state == WAITING){
            output = "Welcome to the Freddy Fazbear's Pizzeria Delivery.\nWhat would you like to do?\n1. Order a Pizza\n2. Talk to Customer Service";
            state = ASK1;
        }else if(state == ASK1){
            ...
            if(input.equalsIgnoreCase("1") || input.equalsIgnoreCase("order a pizza")){
                ...
                state = PEMBELI;
            }else if(input.equalsIgnoreCase("2") || input.equalsIgnoreCase("talk to customer service")){
                output = "Hello partner, how we may help you?\nCould you please give details?\nType 'Store' for store problems\nType 'Payment' for payments problem";
                state = PENJUAL;
            }else{
                output = "Please type only the number or only the sentence (\"1\" or \"order a pizze\")";
            }
