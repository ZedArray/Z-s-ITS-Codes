...
public class ServerApp extends javax.swing.JFrame {
    ...
    private void chatSendActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            //For error handling
            System.out.println("Error when trying to send live chats to the clients");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        String chatIn = "";
        ServiceChatProtocol scp = new ServiceChatProtocol();//the chat-answer protocol system
        try {
            ...
            chatArea.setText("This is the server log\nServer will answer the clients automatically according to the Service Chat Protocol\nServer can only chats to the clients when the clients ask to do a live chat");
            ...
            while(!chatIn.equalsIgnoreCase("exit")){
                ...
                try {
                    ...
                    //for handling error
                    System.out.println("Error when trying to send prefix-message to the clients");
                }
            }
            ...
            //for handling error
            System.out.println("Error when trying to create the server and connects to the clients");
        }
    }
